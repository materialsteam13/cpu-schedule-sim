...
export default function MlfqSimulation({ numProcesses = 5 }) {
    ...
    const generateProcesses = () => {
        const newProcesses = Array.from({ length: numProcesses }, (_, i) => ({
            ...
            burstTime: Math.floor(Math.random() * 15) + 1, // Random burst time between 1-15
        }));
    ...
    return (
        <div className="p-4">
            ...
            <button onClick={runMlfq} className="bg-green-500 text-white px-4 py-2">
                Run MLFQ
            </button>
